...
# podman-compose exec -it postgres psql -U packit -d packit < /tmp/packit.sql
# podman-compose up -d service
# podman-compose exec -it postgres psql -U packit -d packit
...
#    WHERE identifier = '4f2fa9aa-8fe6-4325-a317-473ca180e75d'
#    LIMIT 1
#)
